...
- Checkpoint: `ml-training/floor_rubbish/runs/theme_park_hazards/yolo11n_seg_floor_taco_smoke_revision_2/weights/best.pt`
- Dataset preparation report: `dataset/floor_rubbish/prepared_specialist_dataset/preparation-report.json`

## Validation result

The short run completed without CUDA or data-loader failure. The clean revision 2
...
`artifacts/specialist-evaluations/20260819-floor-taco-test-revision-2/report.json`.
...
`artifacts/specialist-evaluations/20260819-floor-taco-test-full-revision-2/report.json`.
