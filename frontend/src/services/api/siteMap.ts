...
export const getSiteMapAuditEvents = (signal?: AbortSignal) => apiRequest<{ events: SiteMapAuditEvent[] }>("/api/operations/audit-events", { signal }).then((response) => response.events);
