import type { V2Point, V2Zone } from "./operations";

export type NearestZone = { id: string; name: string; distanceMeters: number };

function pointInPolygon(point: V2Point, polygon: V2Point[]) {
  let inside = false;
...
function pointToSegmentDistance(point: V2Point, start: V2Point, end: V2Point) {
...
export function nearestZoneForStation(point: V2Point, zones: V2Zone[]): NearestZone | null {
