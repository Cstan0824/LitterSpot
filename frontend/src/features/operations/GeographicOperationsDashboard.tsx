...
export function GeographicOperationsDashboard({ zones, cameras, alerts, cleaners, recommendations, availabilityById = {}, busyZones, siteMap, siteName = "Active site", onNavigate = defaultNavigate, statusLabel = "Live monitoring", statusDetail = "Updated from V2" }: {
  zones: Zone[];
