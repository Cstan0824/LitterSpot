...
export function LoginPage({ onLogin, onDemoCleaner }: { onLogin: (email: string, password: string) => Promise<void>; onDemoCleaner?: () => void }) {
  ...
  return <main className="login-page"><section className="login-panel">
    ...
    {onDemoCleaner && <button type="button" className="login-demo-cleaner" onClick={onDemoCleaner}>Try Cleaner mobile demo <span>→</span></button>}
