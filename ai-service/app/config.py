...
STATE_CLASSIFIER_PATH = Path(os.getenv(
    ...
    PROJECT_ROOT / "runs/state_classifier/multitask_bin_state/production.pt",
))
STATE_CLASSIFIER_VERSION = os.getenv("STATE_CLASSIFIER_VERSION", "multitask-mobilenet-bin-state")
BIN_LOCALIZER_PATH = Path(os.getenv("BIN_LOCALIZER_PATH", PROJECT_ROOT / "models/production/bin_localizer_yolo11n.pt"))
BIN_LOCALIZER_VERSION = os.getenv("BIN_LOCALIZER_VERSION", "bin-localizer-yolo11n")
