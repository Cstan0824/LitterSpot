...
import { emailReservationId, identityOperationId } from "../services/identityService.js";
...
await firestore.runTransaction(async (transaction) => {
  ...
  transaction.set(firestore.collection("userAccounts").doc(superadmin.uid), {
    schemaVersion: SCHEMA_VERSION, uid: superadmin.uid, role: "superadmin", siteId: null, profileId: superadmin.uid,
  ...
  transaction.set(firestore.collection("userAccountEmails").doc(emailReservationId(superadminEmail)), {
    schemaVersion: SCHEMA_VERSION, emailNormalized: superadminEmail, uid: superadmin.uid, role: "superadmin", profileId: superadmin.uid,
  ...
  transaction.set(firestore.collection("userAccounts").doc(root.uid), {
    schemaVersion: SCHEMA_VERSION, uid: root.uid, role: "supervisor", siteId: siteRef.id, profileId: root.uid,
  ...
  transaction.set(firestore.collection("userAccountEmails").doc(emailReservationId(email)), {
    schemaVersion: SCHEMA_VERSION, emailNormalized: email, uid: root.uid, role: "supervisor", profileId: root.uid,
  ...
  transaction.set(firestore.collection("identityOperations").doc(rootOperationId), {
    schemaVersion: SCHEMA_VERSION, operationId: rootOperationId, type: "create_site_root", siteId: siteRef.id, emailNormalized: email,
  ...
  transaction.set(firestore.collection("supervisors").doc(root.uid), {
    schemaVersion: SCHEMA_VERSION, uid: root.uid, siteId: siteRef.id, authority: "root", fullName: displayName,
