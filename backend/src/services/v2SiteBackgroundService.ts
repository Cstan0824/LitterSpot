...
export async function assertV2SiteBackground(siteId: string, mediaId: string | null | undefined, transform: SiteBackgroundTransform | null | undefined, boundary?: { widthMeters: number; heightMeters: number }) {
...
export async function uploadV2SiteBackground(input: { siteId: string; file: Express.Multer.File; actor: AuditActor; requestId: string }) {
