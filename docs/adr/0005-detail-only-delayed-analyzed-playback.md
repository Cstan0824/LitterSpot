...
This choice prioritizes correct overlays and strong Camera Detail presentation without paying the decoding, memory, and inference cost of continuous delayed playback on every Camera card. It accepts lower-cadence snapshots in the grid and on secondary browsers. A future multi-viewer continuous design would require a stream relay and a larger explicit hardware budget.
